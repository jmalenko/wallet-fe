  ...
  const handleSubmit = (event) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        fetch(import.meta.env.VITE_API_BASE_URL + 'sendExternal/' + accountId + '/' + encodeURIComponent(formData.counterpartyAccountId) + '/' + amount.whole + '/' + amount.decimal + '/' + encodeURIComponent(formData.reference))
          .then((res) => {
